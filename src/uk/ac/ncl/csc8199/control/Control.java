...
public class Control {
	...
	/*
	 * public boolean removeExpiredTuples(LinkedList<Tuple> memory, Long
	 * windowSize) {
	 * 
	 * long latestTuple = System.currentTimeMillis(); long oldestTuple =
	 * memory.getFirst().getTimestamp() + windowSize;
	 * 
	 * if(oldestTuple < latestTuple) {
	 * 
	 * Control.memory.removeFirst(); return true; } return false;
	 * 
	 * }
	 */
